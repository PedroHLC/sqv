...
public class Question {
	...
	public Question(ResultSet rs) throws SQLException{
		id = rs.getInt(1);
		problemtext = Main.unescapeString(rs.getString(2));
		answer1text = Main.unescapeString(rs.getString(3));
		answer2text = Main.unescapeString(rs.getString(4));
		answer3text = Main.unescapeString(rs.getString(5));
		answer4text = Main.unescapeString(rs.getString(6));
		answer5text = Main.unescapeString(rs.getString(7));
		answer6text = Main.unescapeString(rs.getString(8));
		...
		rightanswer = Byte.parseByte(rs.getString(9));
		course = Byte.parseByte(rs.getString(10));
	}
}
